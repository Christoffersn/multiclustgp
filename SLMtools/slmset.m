...
% prescrioption1 = prescription;
% % C2 must be: 'off', 'on', or ''
% prescription = value_check(prescription,'C2', ...
%    {'off' 'on'},[],0);
% 
% if(isequal(prescription,prescrioption1))
% else
%     display('changed at line 925');
% end
% 
...
%   
% if(isequal(prescription,prescrioption1))
%     display('equal at line 1284');
% else
%     display('changed at line 1284');
% end
